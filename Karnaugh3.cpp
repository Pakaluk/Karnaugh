...
/*
Important Message:
Send this code, along with the contents of my CSC 326 notebook, to my friends.
If any of them are capable of completing this work, I would be glad if they did:
Ryan Kim, Jacob Cremers, Rory Kroarkin, Augustine Jauregui, Cloud Barre
*/
